...
public class Content {
    ...
    private static CustomItem createCustomItem(int position) {
        return new CustomItem(String.valueOf(position), "Item " + position, makeDetails(position));
    }
    ...
    public static class CustomItem {
        ...
        public CustomItem(String id, String content, String details) {
            this.id = id;
